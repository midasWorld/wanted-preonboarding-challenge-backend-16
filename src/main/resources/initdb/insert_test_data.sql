...
INSERT INTO `performance` (name, price, round, type, start_date, is_reserve)
VALUES ('로미오와 줄리엣', 200000, 1, 0, '2024-01-21 19:30:00', 'enable');

INSERT INTO performance_seat_info
VALUES (DEFAULT, (SELECT id FROM performance limit 1), 1, 1, 'A', 1, 'enable', DEFAULT, DEFAULT)
...
INSERT INTO performance_seat_info
VALUES (DEFAULT, (SELECT id FROM performance limit 1 offset 1), 1, 1, 'A', 1, 'enable', DEFAULT, DEFAULT)
